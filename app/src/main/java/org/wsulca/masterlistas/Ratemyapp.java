...
public class Ratemyapp {
    ...
    public void showRateDialog(final SharedPreferences.Editor editor) {
        ...
        ImageView laterButton = (ImageView) layout.findViewById(R.id.ratemyapp_dialog_later_button);
        rateButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                callerActivity.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("http://play.google.com/store/apps/details?id="
                        + APP_PACKAGENAME)));
                if (editor != null) {
